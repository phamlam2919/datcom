                    ...
                    <div className="">
                        ...
                        <div className="flex justify-center mb-10">
                            <p className="text-center w-[800px]">
                                Đến với RA, bạn không cần bận tâm các vấn đề vệ
                                sinh an toàn thực phẩm. Với nguyên tắc "Cái đức
                                đặt lên hàng đầu", thức ăn từ khâu chọn lọc đến
                                khâu chế biến đều được đội ngũ bếp chăm chút kỹ
                                lưỡng !
                            </p>
                        </div>
