                                        ...
                                        <div className="flex gap-5 justify-between items-center">
                                            <div className="flex gap-5 items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <form
                                                        onSubmit={
                                                            handleSubmitChooseFood
                                                        }
                                                    >
                                                        <input
                                                            type="number"
                                                            className="bg-gray-50 border w-[100px] border-gray-300  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                            value={
                                                                foodQuantities[
                                                                    food.idFood
                                                                ]
                ...
                <div className="w-1/2 mt-12">
                    <div className="relative overflow-x-auto">
                        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                {Object.entries(selectedFoods).map(
                                    ([userId, foodsArr]) =>
